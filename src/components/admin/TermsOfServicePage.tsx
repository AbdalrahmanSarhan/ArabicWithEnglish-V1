...
export const TermsOfServicePage = () => {
  ...
  const [newSection, setNewSection] = useState<Omit<TermsSection, 'id'>>({
    title: '',
    content: '',
      ...
      <Card className="p-5">
        ...
        <div className="overflow-hidden">
          <div className="overflow-x-auto">
            <Table data={paginatedSections} columns={columns} emptyMessage="No terms of service sections found" sortColumn={sortColumn} sortDirection={sortDirection} onSort={handleSort} />
          </div>
